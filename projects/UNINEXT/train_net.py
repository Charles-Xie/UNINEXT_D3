...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        elif evaluator_type == "d3":
            force_tasks = {"bbox"}
            evaluator_list.append(COCOEvaluator(dataset_name, cfg, True, output_folder, force_tasks=force_tasks, refcoco=False, d3=True))
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        if dataset_name.startswith("coco") or dataset_name.startswith("refcoco") or dataset_name.startswith("objects365_v2") or dataset_name.startswith("d3"):

...
from .d3 import register_d3_instances

# ==== Predefined splits for D3 datasets ===========
_PREDEFINED_SPLITS_D3 = {
    "d3_full": ("d3/full", "annotations/d3/both_expression/coco_annotations.json"),
    "d3_pos": ("d3/pos", "annotations/d3/only_explicit/coco_annotations.json"),
    "d3_neg": ("d3/neg", "annotations/d3/only_antithesis/coco_annotations.json"),
}

def register_all_d3(root):
    d3_metadata = {}
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_D3.items():
